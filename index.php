...
if (isset($_GET['steamid'])) {
    $data = 'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=0CE007C8B50A1DD846EDAE4C0B972953&steamids='.$_GET['steamid'];
...
<body> 
    ...
    <div class="container">
        <div class="jumbotron" style="margin-top: 50px;">
            ...
            <h1 id="title" class="bigEntrance" style="font-size: 50px;">DoctorZambie's Gmod Server :D</h1>
            <p class="lead">
                Welcome to my Server. Have fun!<br>
                <small>
                    <ul style="line-height: 1.6;">
                        <li>Follow ALL the rules.</li>
                        <li>Respect your fellow players/friends .</li>
                        <li>Don't spam text/Voice chat.
                        <li>Absolutly NO Discrimination/Racism/etc...!</li>
                        <li>Absolutly NO Hacking of any sorts.</li>
                        <li>Follow directions</li>
                        <li>Listen to admins.</li>
                    </ul>
                    All used Workshop items can be found here:
                    <br>
                    <code>http://steamcommunity.com/sharedfiles/filedetails/?id=332515460</code><br>→ Servercontent DL (Link)
                </small>            </p>
